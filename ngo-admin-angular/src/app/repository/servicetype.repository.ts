...
import { BASE_URL, DONER_ADD, DONER_DELETE, DONER_GETALL, DONER_GETID, DONER_ISACTIVE_DEACTIVE, EVENT_ADD, EVENT_GETALL, GET_ALL_ACTIVE_DONER, SERVICETYPE_ADD } from "../common/url";
...
export class ServicetypeRepository {
    ...
    //     console.log(FormData);
         ...
         return this.apiClient.doPublicPost(SERVICETYPE_ADD,data);
     }
